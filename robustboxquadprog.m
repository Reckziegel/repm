...
% =========================================================================
function optPortfolio =  robustboxquadprog(returns, lambda, alpha)
    ...
    % Compute the inputs for the quadprog function
	identity = eye(n);
    ...
    options = optimset('Display', 'notify', 'Algorithm', ...
        'interior-point-convex', 'MaxIter', 1E10, 'MaxFunEvals', 1E10);
    
    x = quadprog(2 * transform' * sigma * transform, ...
        -lambda * muTransformed, [], [], Aeq, beq, lb, [], x0, options);
